...
@Injectable()
export class AnimalsStandardService {
  constructor(
  ...
  async create(createAnimalDto: CreateAnimalDto): Promise<Animal> {
    ...
    console.log('### LEAN ###');
    this.print(createdAnimalDoc.toObject()); // will accept `createAnimal` as LeanDocument<Animal>, even if it isn't
    this.printFoodPlan(createdAnimalDoc.toObject().foodPlan);

    return createdAnimalDoc;
  }
